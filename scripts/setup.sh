...
echo ""
[[ -n "$SONARR_PORT" ]]   && echo "  export SONARR_URL=http://${HOST}:${SONARR_PORT}"
[[ -n "$RADARR_PORT" ]]   && echo "  export RADARR_URL=http://${HOST}:${RADARR_PORT}"
[[ -n "$LIDARR_PORT" ]]   && echo "  export LIDARR_URL=http://${HOST}:${LIDARR_PORT}"
[[ -n "$READARR_PORT" ]]  && echo "  export READARR_URL=http://${HOST}:${READARR_PORT}"
[[ -n "$PROWLARR_PORT" ]] && echo "  export PROWLARR_URL=http://${HOST}:${PROWLARR_PORT}"
[[ -n "$BAZARR_PORT" ]]   && echo "  export BAZARR_URL=http://${HOST}:${BAZARR_PORT}"
[[ -n "$OVERSEERR_PORT" ]] && echo "  export OVERSEERR_URL=http://${HOST}:${OVERSEERR_PORT}"
[[ -n "$PLEX_PORT" ]]     && echo "  export PLEX_URL=http://${HOST}:${PLEX_PORT}"
[[ -n "$TAUTULLI_PORT" ]] && echo "  export TAUTULLI_URL=http://${HOST}:${TAUTULLI_PORT}"
[[ -n "$SABNZBD_PORT" ]]  && echo "  export SABNZBD_URL=http://${HOST}:${SABNZBD_PORT}"
echo ""
